...
Read and follow `E:/externalProjects/workforce-management/.claude/gsd-core/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
