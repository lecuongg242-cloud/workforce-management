...
- Usage: Reference from command with `@E:/externalProjects/workforce-management/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to E:/externalProjects/workforce-management/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to E:/externalProjects/workforce-management/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
