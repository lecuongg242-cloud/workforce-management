...
<!-- For checkpoint task examples and patterns, see @E:/externalProjects/workforce-management/.claude/gsd-core/references/checkpoints.md -->
...
See `E:/externalProjects/workforce-management/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `E:/externalProjects/workforce-management/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `E:/externalProjects/workforce-management/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
