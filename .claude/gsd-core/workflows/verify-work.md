...
<template>
@E:/externalProjects/workforce-management/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@E:/externalProjects/workforce-management/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `E:/externalProjects/workforce-management/.claude/gsd-core/workflows/transition.md`.
...
- Follow @E:/externalProjects/workforce-management/.claude/gsd-core/workflows/diagnose-issues.md
