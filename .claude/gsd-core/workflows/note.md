...
- **Global scope**: `E:/externalProjects/workforce-management/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `E:/externalProjects/workforce-management/.claude/notes/`)
...
2. Glob `E:/externalProjects/workforce-management/.claude/notes/*.md` (if directory exists) — global notes
...
Global (E:/externalProjects/workforce-management/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `E:/externalProjects/workforce-management/.claude/notes/` — works in any directory
