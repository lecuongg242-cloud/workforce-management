...
<required_reading>
@E:/externalProjects/workforce-management/.claude/gsd-core/references/user-story-template.md
@E:/externalProjects/workforce-management/.claude/gsd-core/references/spidr-splitting.md
@E:/externalProjects/workforce-management/.claude/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@E:/externalProjects/workforce-management/.claude/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@E:/externalProjects/workforce-management/.claude/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@E:/externalProjects/workforce-management/.claude/gsd-core/references/spidr-splitting.md`. Briefly:
