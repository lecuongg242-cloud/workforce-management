...
ones). Reference: @E:/externalProjects/workforce-management/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / E:/externalProjects/workforce-management/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "E:/externalProjects/workforce-management/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "E:/externalProjects/workforce-management/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @E:/externalProjects/workforce-management/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @E:/externalProjects/workforce-management/.claude/gsd-core/templates/spec.md.
