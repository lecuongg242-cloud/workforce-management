...
```markdown
Read E:/externalProjects/workforce-management/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: E:/externalProjects/workforce-management/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read E:/externalProjects/workforce-management/.claude/agents/gsd-ui-checker.md for instructions.
...
@E:/externalProjects/workforce-management/.claude/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / E:/externalProjects/workforce-management/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "E:/externalProjects/workforce-management/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "E:/externalProjects/workforce-management/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
