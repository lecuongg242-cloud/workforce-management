...
Key references:
- @E:/externalProjects/workforce-management/.claude/gsd-core/references/ui-brand.md (display patterns)
- @E:/externalProjects/workforce-management/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @E:/externalProjects/workforce-management/.claude/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="E:/externalProjects/workforce-management/.claude/gsd-core/USER-PROFILE.md"
...
```bash
cp "E:/externalProjects/workforce-management/.claude/gsd-core/USER-PROFILE.md" "E:/externalProjects/workforce-management/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at E:/externalProjects/workforce-management/.claude/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `E:/externalProjects/workforce-management/.claude/gsd-core/references/user-profiling.md`
...
Reference: @E:/externalProjects/workforce-management/.claude/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to E:/externalProjects/workforce-management/.claude/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to E:/externalProjects/workforce-management/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at E:/externalProjects/workforce-management/.claude/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at E:/externalProjects/workforce-management/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to E:/externalProjects/workforce-management/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="E:/externalProjects/workforce-management/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    E:/externalProjects/workforce-management/.claude/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   E:/externalProjects/workforce-management/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       <resolved claude_md_path, default ./.claude/CLAUDE.md>
  ✓ Global CLAUDE.md        E:/externalProjects/workforce-management/.claude/CLAUDE.md
```
