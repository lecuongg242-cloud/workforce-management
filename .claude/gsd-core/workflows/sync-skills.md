...
INSTALL_JS_GLOBAL="E:/externalProjects/workforce-management/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node E:/externalProjects/workforce-management/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
