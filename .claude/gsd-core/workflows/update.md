...
for cand in \
  ...
  "E:/externalProjects/workforce-management/.claude/gsd-core/bin/gsd-tools.cjs"; do
...
global: `E:/externalProjects/workforce-management/.claude/`, `~/.config/opencode/`, `~/.opencode/`, `~/.gemini/`, `~/.config/kilo/`, or `~/.codex/`
