...
See E:/externalProjects/workforce-management/.claude/gsd-core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using E:/externalProjects/workforce-management/.claude/gsd-core/templates/discovery.md structure:
...
1. **Scope the discovery** using E:/externalProjects/workforce-management/.claude/gsd-core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from E:/externalProjects/workforce-management/.claude/gsd-core/templates/discovery.md
...
Use E:/externalProjects/workforce-management/.claude/gsd-core/templates/discovery.md.
