...
<required_reading>
@E:/externalProjects/workforce-management/.claude/gsd-core/references/ai-frameworks.md
@E:/externalProjects/workforce-management/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read E:/externalProjects/workforce-management/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "E:/externalProjects/workforce-management/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read E:/externalProjects/workforce-management/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read E:/externalProjects/workforce-management/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read E:/externalProjects/workforce-management/.claude/agents/gsd-eval-planner.md for instructions.
