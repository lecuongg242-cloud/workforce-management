...
@E:/externalProjects/workforce-management/.claude/gsd-core/references/git-integration.md
</required_reading>
...
See `E:/externalProjects/workforce-management/.claude/gsd-core/references/tdd.md` for structure.
</tdd_plan_execution>
...
See E:/externalProjects/workforce-management/.claude/gsd-core/references/checkpoints.md for details.
</step>
...
Create `{phase}-{plan}-SUMMARY.md` at `.planning/phases/XX-name/`. Use `E:/externalProjects/workforce-management/.claude/gsd-core/templates/summary.md`.
