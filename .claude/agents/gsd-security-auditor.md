...
**Verification depth scales with `asvs_level`** (see @E:/externalProjects/workforce-management/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
