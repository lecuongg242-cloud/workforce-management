...
<required_reading>
Read `E:/externalProjects/workforce-management/.claude/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
