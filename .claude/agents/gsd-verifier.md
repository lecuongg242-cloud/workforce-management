...
<required_reading>
@E:/externalProjects/workforce-management/.claude/gsd-core/references/verification-overrides.md
...
@E:/externalProjects/workforce-management/.claude/gsd-core/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@E:/externalProjects/workforce-management/.claude/gsd-core/references/few-shot-examples/verifier.md
...
**When the phase under verification has `mode: mvp` in ROADMAP.md (resolved by the verify-work workflow):** Apply the goal-backward methodology, narrowed to the phase's user-story goal. Required reading: `@E:/externalProjects/workforce-management/.claude/gsd-core/references/verify-mvp-mode.md`.
