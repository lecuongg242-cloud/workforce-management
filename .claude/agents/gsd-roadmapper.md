...
Reference full template: `E:/externalProjects/workforce-management/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `E:/externalProjects/workforce-management/.claude/gsd-core/templates/state.md`.
