...
<reference>
@E:/externalProjects/workforce-management/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `E:/externalProjects/workforce-management/.claude/gsd-core/references/user-profiling.md` to load:
