...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `E:/externalProjects/workforce-management/.claude/.gsd-surface.json`
(sibling to `E:/externalProjects/workforce-management/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `E:/externalProjects/workforce-management/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`E:/externalProjects/workforce-management/.claude/skills`).
...
`E:/externalProjects/workforce-management/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `E:/externalProjects/workforce-management/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `E:/externalProjects/workforce-management/.claude/.gsd-surface.json`
Install profile marker: `E:/externalProjects/workforce-management/.claude/.gsd-profile`
Skill dirs: `E:/externalProjects/workforce-management/.claude/skills/gsd-*/`
Engine module: `E:/externalProjects/workforce-management/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `E:/externalProjects/workforce-management/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
